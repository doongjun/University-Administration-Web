					...
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="javascript:void(0)">강의 수정</a></li>
						</ol>
					</div>
				</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">강의수정 교수번호 ${professor.id }</h4>
							</div>
							<div class="card-body">
									...
									<form id="profForm" class="form-valide">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<input name="id" type="hidden" value="${vo.id}"> <label>강의제목</label>
												<input name="lecture_name" value="${vo.lecture_name}"
													type="text" class="form-control" required>

											</div>
											<div class="form-group col-md-6">
												<label>학과</label> <select name="dept_code"
													value="${vo.dept_code}" id="inputState"
													class="form-control">
											...
											<div class="form-group col-md-6">
												<label>대상학년</label> <select value="${vo.grade}" name="grade"
											...
											<div class="form-group col-md-6">
												<label>강의실</label> <input name="classroom"
													value="${vo.classroom}" type="text" class="form-control"
													placeholder="예) 덮밥관 201호">
											</div>
											<div class="form-group col-md-6">
												<label>강의시간</label> <input name="lecture_time"
													value="${vo.lecture_time}" type="text" class="form-control"
													placeholder="예) 수 1,2,3">
											</div>
											<div class="form-group col-md-6">
												<label>분반</label> <select name="division"
													value="${vo.division}" id="inputState" class="form-control">
													<option>1분반</option>
													<option>2분반</option>
													<option>3분반</option>
											...
											<div class="form-group col-md-6">
												<label>학점</label> <input name="credit" value="${vo.credit}"
													type="number" min="1" max="3" class="form-control"
													placeholder="3">
											</div>
											<div class="form-group col-md-6">
												<label>구분</label> <select name="section"
													value="${vo.section}" id="inputState" class="form-control">
													<option selected="">전공/전공기초</option>
													<option>교양/기타</option>
												</select>
											</div>
											<div class="form-group col-md-6">
												<label>수강정원</label> <input name="student_full"
													value="${vo.student_full}" type="number" min="1" max="300"
													class="form-control" placeholder="30"> <small
													id="passwordHelpBlock" class="form-text text-muted">
													* 정원 변경시 과사무실에 문의바랍니다. </small>
											</div>
											<div class="form-group col-md-6">
												<label>비고</label> <input name="remarks"
													value="${vo.remarks}" type="text" class="form-control"
													placeholder="생략가능. 최대 30자">
											</div>
										</div>
										...
										<button class="btn btn-primary"
											onclick="history.back(-1);return false;">취소</button>
